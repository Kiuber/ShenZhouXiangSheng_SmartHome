package com.pcstar.people.socket;
/**
 * 描述：蓝牙服务核心类
 */
...
import com.pcstar.people.activity.MainActivity;
                ...
                try {
                    ...
                    if(bytes>0)
                    {
                    	...
                    	if (str.endsWith("0D")) {
                    		...
                    		mHandler.obtainMessage(MainActivity.MESSAGE_READ, buffer1.length, -1, buffer1)
                            .sendToTarget();
                    		str1 = "";
						}
                    	else{
